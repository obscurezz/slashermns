	...
	return {
		{
			spells = { 	
						...
						rnd('g000ss0192','g000ss0191','g000ss0177'), -- Песнь Мимира / Проведение Всевышнего / Откровение 
		...
		subraceTypes = rsub(),		
			...
			loot = {
				...
				items = {
					...
					{ id = gmm(rnd('g001ig0530','g001ig0530',rms()), rnd(pw4d(),rms())), min = 1, max = 1 }, -- зелье посмертного зова (талики) 66% / случ.шар манны 33% /G/ Случ перм вард-дот / случ.шар манны
		...
		stack = {
			...
			loot = {
				items = {
					...
					{ id = gmm(rnd('g001ig0524','g001ig0524',ExtraMana(playerRace)), rnd(pw4e(),ExtraMana(playerRace))), min = 1, max = 1 }, -- Зелье завоевателя (жезлы) 66% / шар доп маны 33% /G/ Случ перм вард-эффект / шар доп маны
		...
		stack = {
			...
			loot = {
				...
				items = {
					...
					{ id = gmm(rnd('g001ig0526','g001ig0527',p05(),p05(),p05(),ExtraHomeMana(playerRace)), rnd(p05(),ExtraHomeMana(playerRace))), min = 1, max = 1 }, -- Зелье оруженосца (знамёна) / Зелье постижения (реликвии) / Пермо 5% / шар родной манны /G/ Пермо 5% / шар родной манны
...
return {
	{
		goods = {
			...
			items = {
				...
				orr({ id = 'g001ig0526', min = 1, max = 1 }, { id = 'g001ig0527', min = 1, max = 1 }), -- Зелье оруженосца (знамёна) / Зелье постижения (реликвии)
				{ id = rnd('g001ig0519','g001ig0083','g001ig0548','g001ig0324'), min = 1, max = 1 }, -- Война престолов (-10 воры) 500 / Зелье рвения (+5 ини и точности) / Зелье удачи (10 крит) / Зелье загробных тайн (п.вард оружие)
...
return {
	{
		goods = {
			...
			items = {
				...
				{ id = rnd('g001ig0534','g001ig0352','g001ig0356','g001ig0312','g001ig0521'), min = 1, max = 1 }, -- Экстракт таинственной энергии-смена-атак / Эликсир гонителя нечисти-вамп-там / Зелье вознесения-вард-урон / Эликсир предвиденья =15точн-1 / Зелье разоблачения (-20 воры)
...
-- ШАБЛОН
template = {
	name = gmm('Outrunner 2.9l', 'Outcross 2.9l'),
