...
--				yn({ id = spherex(), min = 1, max = 1 }), -- сфера икс
				...
				--талик
				orr(orr({ id = 'g000ig9128', min = 1, max = 1}, { id = 'g001ig0259', min = 1, max = 1}), orr({ id = 'g001ig0063', min = 1, max = 1}, { id = 'g000ig9116', min = 1, max = 1})), -- Талисман Молнии 800 / Талисман призыва нейтралов III 600 / Талисман Прилива 800 / Талисман Святой земли 800
				{ id = rnd('g000ig9130','g000ig9123','g000ig9103'), min = 1, max = 1}, -- Талисман Бури / Талисман Пожара / Талисман призыва нейтралов V --пока не пофиксят убрал g001ig0202 Талисман призыва нейтралов IV
...
--				yn({ id = 'g001ig0596', min = 1, max = 1 }), -- Линарет (Реликвия)
				...
				--талик
				{ id = rnd('g000ig9130','g000ig9123'), min = 1, max = 1}, -- Талисман Бури / Талисман Пожара / --пока не пофиксят убрал g001ig0202 Талисман призыва нейтралов IV
...
--				itemValue = { min = 850, max = 1090 }
			items = {
				...
				-- Чаша жатвы (Артефакт) / Череп шамана (Артефакт) / Щит отражения (Артефакт) / Эльфийская брошь (Артефакт) / --пока не пофиксят убрал g001ig0202 Талисман призыва нейтралов IV
...
-- ШАБЛОН
template = {
	name = gmm('Outrunner 2.9f', 'Outcross 2.9f'),
