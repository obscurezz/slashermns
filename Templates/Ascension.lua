...
function tier1stackOrb(tier)
    return {
        ...
        subraceTypes = subraceRandomizer(tier),
        loot = {
            itemTypes = { Item.Orb, Item.PotionHeal },
...
local talismans_2_01 = { 'g000ig9130', 'g000ig9128', 'g000ig9123', 'g001ig0063', 'g000ig9116' }
local armor_2_01 = { 'g001ig0155', 'g001ig0124', 'g001ig0612', 'g001ig0045', 'g000ig2003', 'g001ig0040', 'g001ig0558', 'g001ig0557', 'g001ig0559', 'g001ig0047', 'g001ig0416', 'g001ig0041', 'g001ig0589', 'g001ig0591', 'g001ig0594', 'g001ig0071' }
local weapon_2_01 = { 'g000ig3019', 'g001ig0488', 'g000ig3003', 'g001ig0173', 'g001ig0197', 'g001ig0417', 'g001ig0415', 'g001ig0196', 'g000ig9137', 'g001ig0657' }
local jewel_2_01 = { 'g001ig0420', 'g001ig0104', 'g001ig0422', 'g001ig0423', 'g001ig0429', 'g002ig0002', 'g001ig0430', 'g001ig0539', 'g001ig0037' }

local wands_2_02 = { 'g000ig6015', 'g001ig0096', 'g000ig6013', 'g000ig6020', 'g000ig6014', 'g001ig0391', 'g001ig0398' }
local banner_2_02 = { 'g000ig1005', 'g001ig0051', 'g000ig1001', 'g001ig0370', 'g000ig1007', 'g001ig0369', 'g000ig1003', 'g001ig0142', 'g001ig0140', 'g001ig0141', 'g001ig0139', 'g001ig0145', 'g001ig0588', 'g001ig0289' }
local travel_2_02 = { 'g001ig0112', 'g000ig1011', 'g001ig0606', 'g000ig8003', 'g000ig1010' }

local banner_3 = { 'g001ig0293', 'g000ig1004', 'g001ig0364', 'g001ig0361', 'g001ig0357', 'g001ig0363', 'g001ig0358', 'g000ig1008', 'g001ig0365', 'g002ig0003', 'g001ig0292', 'g001ig0367', 'g000ig1002' }
local jewel_3 = { 'g001ig0424', 'g001ig0425', 'g001ig0597', 'g001ig0156', 'g001ig0419' }
local permanent_3 = { 'g001ig0563', 'g001ig0025', 'g001ig0024', 'g001ig0021', 'g001ig0031' }

local top_perma = { 'g001ig0312', 'g001ig0310', 'g001ig0314', 'g001ig0316', 'g001ig0518', 'g001ig0308' }
...
function townTier1_2Guard(tier)
    return {
        ...
        loot = {
            itemTypes = { Item.Valuable },
            value = { min = 2000, max = 2000 },
            itemValue = { min = 1000, max = 2000 },
            items = {
                { id = 'g000ig0001', min = 1, max = 1 },
                { id = 'g000ig0018', min = 1, max = 1 },
                { id = wands_2_02[math.random(#wands_2_02)], min = 1, max = 1 },
...
function townTier2Guard(tier)
    return {
        subraceTypes = subraceRandomizer(tier),
        value = { min = 500, max = 570 },
        loot = {
            itemTypes = { Item.Valuable },
            value = { min = 2500, max = 2500 },
            itemValue = { min = 500, max = 2000 },
            items = {
                ...
                { id = t3Orbs[math.random(#t3Orbs)], min = 1, max = 1 },
            }
        }
    }
end
...
function zoneHighPotionGuard(tier)
    return {
        ...
        loot = {
            itemTypes = { Item.PotionBoost },
            value = { min = 750, max = 850 },
            itemValue = { min = 250, max = 425 },
            items = {
                { id = 'g000ig0001', min = 1, max = 1 }
            }
        }
...
function zoneGreatGuard(tier)
    ...
    return {
        ...
        loot = {
            ...
            items = {
                { id = 'g001ig0152', min = 1, max = 1 },
                { id = top_perma[math.random(#top_perma)], min = 1, max = 1 }
            }
        }
    }
end
...
function getSkirmishZone(zoneId, zoneSize, races)
    return {
        ...
        ruins = {
            {
                ...
                loot = {
                    items = {{ id = banner_3[math.random(#banner_3)], min = 1, max = 1 }}
                },
                guard = {
            ...
            },
            {
                gold = {min = 450, max = 550},
                loot = {
                    items = {{ id = jewel_3[math.random(#jewel_3)], min = 1, max = 1 }}
                },
                guard = {
                    subraceTypes = subraceRandomizer(3),
                    value = {min = 450, max = 520}
        ...
        resourceMarkets = {
            {
                stock = {
                    {resource = Resource.Gold, value = { min = 2000, max = 2000 }},
...
template = {
    ...
    forbiddenItems = {
        ...
        'g000ig5066',
        'g000ig5103',
        --banners too strong for its pirce
        'g001ig0362',
        'g001ig0289',
        'g000ig1002',
        --
