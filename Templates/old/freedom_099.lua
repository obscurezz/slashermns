...
function getStack(tier, stackCount, itemTypesTable, itemValuesTable)
    ...
    local t3Items = { { id = 'g000ig0005', min = stackCount * 1.5, max = stackCount * 2 }, { id = 'g000ig0001', min = stackCount * 0.4, max = stackCount * 0.6 }, { id = 'g000ig0006', min = stackCount * 0.5, max = stackCount * 0.7 }, { id = 'g001ig0378', min = stackCount * 0.7, max = stackCount * 1 } }
...
template = {
    ...
    name = 'freedom 0.9.9',
    description = 'freedom 0.9.9S by obscure, SMNS2, 72x72 or 96x96, 2 players, 2 big zones, 4 junction zones, 1 treasure zone',
    minSize = 72,
    maxSize = 96,
    maxPlayers = 2,
    roads = 50,
