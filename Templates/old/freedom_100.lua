...
function getStack(tier, stackCount, itemTypesTable, itemValuesTable)
    ...
    local t1Items = { { id = 'g001ig0180', min = stackCount * 1, max = stackCount * 1 }, { id = 'g000ig0005', min = stackCount * 1, max = stackCount * 2 }, { id = 'g000ig0006', min = stackCount * 0.8, max = stackCount * 1.3 } }
    local t2Items = { { id = 'g001ig0180', min = stackCount * 1, max = stackCount * 1 }, { id = 'g000ig0005', min = stackCount * 1, max = stackCount * 2 }, { id = 'g000ig0001', min = stackCount * 0.5, max = stackCount * 0.8 }, { id = 'g001ig0378', min = stackCount * 0.7, max = stackCount * 1 } } 
    local t3Items = { { id = 'g000ig0005', min = stackCount * 1.5, max = stackCount * 2 }, { id = 'g000ig0001', min = stackCount * 0.5, max = stackCount * 1 }, { id = 'g000ig0006', min = stackCount * 0.5, max = stackCount * 0.7 }, { id = 'g001ig0378', min = stackCount * 0.7, max = stackCount * 1 } }
    local t4Items = { { id = 'g001ig0378', min = stackCount * 0,6, max = stackCount * 0,9 }, { id = 'g000ig0001', min = stackCount * 0.5, max = stackCount * 1 }, { id = 'g000ig0006', min = stackCount * 0.8, max = stackCount * 1.2 }, { id = 'g000ig0018', min = stackCount * 0.5, max = stackCount * 1 } }
...
function getStartingZone(zoneId, playerRace, zoneSize)
    ...
    local zoneStacks = {
            ...
            getStack(1, 2, { Item.Scroll, Item.PotionBoost, Item.PotionHeal }, { min = 150, max = 500 }),
...
function getBufferZone(zoneId, playerRace, zoneSize)
    ...
    local zoneStacks = {
            getStack(2, 2, { Item.PotionBoost, Item.Scroll, Item.PotionHeal }, { min = 50, max = 400 }),
            getStack(4, 1, { Item.PotionPermanent, Item.PotionBoost }, { min = 250, max = 600 }),
            getStack(3, 2, { Item.Scroll }, { min = 200, max = 550 }),
            getStack(3, 1, { Item.Valuable, Item.PotionBoost, Item.Orb }, { min = 150, max = 500 }),
            getStack(2, 1, { Item.PotionBoost, Item.Valuable, Item.PotionRevive }, { min = 150, max = 750 }),
            getStack(2, 2, { Item.Scroll, Item.PotionBoost, Item.PotionHeal }, { min = 200, max = 400 }),
...
function getTreasureZone(zoneId, zoneSize)
    local zoneStacks = {
            ...
            getStack(3, 2, { Item.PotionBoost, Item.Scroll }, { min = 200, max = 450 }),
            getStack(3, 1, { Item.Valuable, Item.Scroll, Item.PotionBoost }, { min = 400, max = 750 }),
...
function getBigZone(zoneId, zoneSize)
    local zoneStacks = {
            ...
            getStack(3, 2, { Item.PotionBoost, Item.Scroll }, { min = 150, max = 550 }),
            getStack(3, 3, { Item.Orb, Item.Valuable }, { min = 500, max = 750}),
            getStack(3, 2, { Item.Scroll, Item.PotionBoost }, { min = 200, max = 700 }),
...
template = {
    ...
    name = 'freedom 1.0.0',
    description = 'freedom 1.0.0S by obscure, SMNS2, 72x72, 2 players, 2 big zones, 4 junction zones, 1 treasure zone',
    minSize = 72,
    maxSize = 72,
    maxPlayers = 2,
    roads = 50,
