...
function getGuard(tier, itemsTable, subR)
    ...
    elseif (tier == 6) then
        ...
        experienceValue.max = 250 * tier * 1.14
    end
...
function getBufferZone(zoneId, playerRace, zoneSize)
    ...
    local zoneRuins = {
            ...
            getRuins(2, { min = 410, max = 490 }, getGuard(2, { }, subraceRandomizer(1)), rewardGenerator('ruins', 'bufferBanner')),
        }
...
function getTreasureZone(zoneId, zoneSize)
    ...
    local zoneRuins = {
            getRuins(4, { min = 450, max = 550 }, getGuard(4, { }, subraceRandomizer(2)), rewardGenerator('ruins', 'centerArtifactT4')),
            getRuins(3, { min = 400, max = 500 }, getGuard(4, { }, subraceRandomizer(2)), rewardGenerator('ruins', 'centerThief')),
            getRuins(4, { min = 450, max = 550 }, getGuard(5, { }, subraceRandomizer(2)), rewardGenerator('ruins', 'centerJewelT4')),
            getRuins(5, { min = 350, max = 500 }, getGuard(6, { }, subraceRandomizer(GO)), rewardGenerator('ruins', 'centerControl')),
            getRuins(5, { min = 350, max = 500 }, getGuard(5, { }, subraceRandomizer(2)), rewardGenerator('ruins', 'centerBannerT4')),
        }
    ...
    local zoneTowns = {
            ...
            getNeutralTown(4, rewardGenerator('town', 'centerT4'), getGuard(4, rewardGenerator('guard', 'townT4'), subraceRandomizer(GO))),
        }
...
function getBigZone(zoneId, zoneSize)
    ...
    local zoneRuins = {
            getRuins(4, { min = 500, max = 570 }, getGuard(4, { }, subraceRandomizer(2)), rewardGenerator('ruins', 'bigMana')),
            getRuins(4, { min = 550, max = 620 }, getGuard(4, { }, subraceRandomizer(2)), rewardGenerator('ruins', 'bigArtifact')),
            getRuins(4, { min = 600, max = 800 }, getGuard(4, { }, subraceRandomizer(2)), rewardGenerator('ruins', 'bigJewel')),
            getRuins(5, { min = 350, max = 500 }, getGuard(6, { }, subraceRandomizer(GO)), rewardGenerator('ruins', 'bigControl')),
        }
...
template = {
    name = 'freedom 1.1.1',
    description = 'freedom 1.1.1S by obscure, SMNS2, 72x72, 2 players, 2 big zones, 4 junction zones, 1 treasure zone',
    minSize = 72,
    maxSize = 72,
    maxPlayers = 2,
    roads = 50,
