...
-- случайный эликсир 200 (от-яд з1)
function e2()
...
function zoneStacksRespZ003() -- не добавлен!
return { -- 200*1
		count = 1,
		value = { min = 200*kef, max = 200*kef },
		loot = {
			items = {
				{ id = 'g000ig0006', min = 1, max = 1 }, --хил100
				orr({ id = 'g000ig7001', min = 1, max = 1 }, { id = rmss(), min = 1, max = 1 }), --кольцо50 / случ.мал.шар манны
...
function getZones(races)
	...
	zones[3] = getPlayerZone(2, races[1], 14) -- синий 21 г1+л2+р2+б1+н1+и6(3)=100
	...
	zones[7] = getPlayerZone(6, races[2], 14) -- жёлтый 21
...
-- ШАБЛОН
template = {
	name = gmm('Outrunner 2.4b', 'Outcross 2.4b'),
	description = gmm('Шаблон для игры 1 героем, 1 жезловиком, 1 вором. Черной зоны должны касаться: синяя, желтая, белая, серая. Поддержать МИР карта: 2200700846776804', 'Шаблон для классической игры. Черной зоны должны касаться: синяя, желтая, белая, серая. Поддержать МИР карта: 2200700846776804'),
	minSize = 72,
	maxSize = 72,
	maxPlayers = 2,
