...
function rewardGenerator(objectType, objectDefinition)
	...
	local t3Artifacts = {'g001ig0046', 'g000ig3006', 'g001ig0174', 'g000ig3004', 'g000ig9035', 'g001ig0415', 'g001ig0604', 'g001ig0411', 'g000ig2004', 'g001ig0585', 'g001ig0410', 'g001ig0060', 'g001ig0590', 'g001ig0413'}
	...
	elseif objectType == 'ruins' and objectDefinition == 'bigArtifact' then
		table.insert(rewardTable, { id = t3Artifacts[math.random(#t3Artifacts)], min = 1, max = 1})
	elseif objectType == 'ruins' and objectDefinition == 'centerBannerJewel' then
        rewardRandomFlag = math.random(0,1)
        if rewardRandomFlag == 0 then
		    table.insert(rewardTable, { id = t3Banners[math.random(#t3Banners)], min = 1, max = 1})
        elseif rewardRandomFlag == 1 then
	...
	elseif objectType == 'ruins' and objectDefinition == 'centerJewelT4' then
		table.insert(rewardTable, { id = t4Jewels[math.random(#t4Jewels)], min = 1, max = 1})
	elseif objectType == 'ruins' and objectDefinition == 'centerBannerArtifact' then
		rewardRandomFlag = math.random(0,1)
		if rewardRandomFlag == 0 then
			table.insert(rewardTable, { id = t4Artifacts[math.random(#t4Artifacts)], min = 1, max = 1})
		elseif rewardRandomFlag == 1 then
...
function getStartingZone(zoneId, playerRace, zoneSize, scenarioSize)
    ...
    if scenarioSize == 72 then
        zoneRuins = {
            getRuins(1, { min = 340, max = 400 }, getGuard(1, { }), rewardGenerator('ruins', 'startJewel')),
            getRuins(1, { min = 340, max = 400 }, getGuard(1, { }), rewardGenerator('ruins', 'startPermanent')),
            getRuins(2, { min = 430, max = 510 }, getGuard(2, { }), rewardGenerator('ruins', 'startArtifact'))
        }
    elseif scenarioSize == 96 then
        zoneRuins = {
            getRuins(1, { min = 340, max = 400 }, getGuard(1, { }), rewardGenerator('ruins', 'startJewel')),
            getRuins(1, { min = 340, max = 400 }, getGuard(1, { }), rewardGenerator('ruins', 'startPermanent')),
            getRuins(2, { min = 430, max = 510 }, getGuard(2, { }), rewardGenerator('ruins', 'startArtifact')),
            getRuins(2, { min = 410, max = 480 }, getGuard(2, { }), rewardGenerator('ruins', 'startTravel'))
        }
    end
        ...
        merchants = {
            {
                ...
                guard = getGuard(2, rewardGenerator('guard', 'merchGuardT2'))   
            }
        },
        
        towns = {
            getNeutralTown(1, rewardGenerator('town', 'startT1'), getGuard(1, rewardGenerator('guard', 'townT1'))),
            getNeutralTown(2, rewardGenerator('town', 'startT2'), getGuard(2, rewardGenerator('guard', 'townT2')))
        },

        mages = {
            getMageTower(1, getGuard(2, rewardGenerator('guard', 'merchGuardT2')))
        },
    }
end
...
function getBufferZone(zoneId, playerRace, zoneSize, scenarioSize)
    ...
    if scenarioSize == 72 then
        zoneRuins = {
            getRuins(3, { min = 500, max = 570 }, getGuard(3, { }), rewardGenerator('ruins', 'bufferArtifactJewel')),
            getRuins(2, { min = 410, max = 490 }, getGuard(2, { }), rewardGenerator('ruins', 'bufferBanner')),
        }
    elseif scenarioSize == 96 then
        zoneRuins = {
            getRuins(3, { min = 500, max = 570 }, getGuard(3, { }), rewardGenerator('ruins', 'bufferArtifactJewel')),
            getRuins(2, { min = 410, max = 490 }, getGuard(2, { }), rewardGenerator('ruins', 'bufferTravel')),
            getRuins(2, { min = 410, max = 490 }, getGuard(2, { }), rewardGenerator('ruins', 'bufferBanner')),
        }
    end
	...
	return {
        ...
        towns = {
            getNeutralTown(3, rewardGenerator('town', 'bufferT3'), getGuard(3, rewardGenerator('guard', 'townT3')))
        }
	}
end
...
function getTreasureZone(zoneId, zoneSize, scenarioSize)
    ...
    if scenarioSize == 72 then
        zoneRuins = {
            getRuins(4, { min = 600, max = 750 }, getGuard(4, { }), rewardGenerator('ruins', 'centerArtifactT4')),
            getRuins(3, { min = 450, max = 550 }, getGuard(3, { }), rewardGenerator('ruins', 'centerTravel')),
            getRuins(4, { min = 700, max = 800 }, getGuard(4, { }), rewardGenerator('ruins', 'centerBannerJewel')),
            getRuins(5, { min = 820, max = 1000 }, getGuard(6, { }), rewardGenerator('ruins', 'centerJewelT4')),
            getRuins(5, { min = 820, max = 1000 }, getGuard(5, { }), rewardGenerator('ruins', 'centerBannerArtifact')),
        }
    elseif scenarioSize == 96 then
        zoneRuins = {
            getRuins(4, { min = 600, max = 750 }, getGuard(4, { }), rewardGenerator('ruins', 'centerArtifactT4')),
            getRuins(3, { min = 450, max = 550 }, getGuard(3, { }), rewardGenerator('ruins', 'centerTravel')),
            getRuins(4, { min = 700, max = 800 }, getGuard(4, { }), rewardGenerator('ruins', 'centerArtifactT4')),
            getRuins(4, { min = 700, max = 800 }, getGuard(4, { }), rewardGenerator('ruins', 'centerBannerJewel')),
            getRuins(5, { min = 820, max = 1000 }, getGuard(6, { }), rewardGenerator('ruins', 'centerJewelT4')),
            getRuins(5, { min = 820, max = 1000 }, getGuard(5, { }), rewardGenerator('ruins', 'centerBannerArtifact')),
        }
    ...
    if scenarioSize == 72 then
        zoneTowns = {
            getNeutralTown(5, rewardGenerator('town', 'centerT5'), getGuard(5, rewardGenerator('guard', 'townT5'))),
            getNeutralTown(4, rewardGenerator('town', 'centerT4'), getGuard(4, rewardGenerator('guard', 'townT4'))),
        }
    elseif scenarioSize == 96 then
        zoneTowns = {
            getNeutralTown(5, rewardGenerator('town', 'centerT5'), getGuard(5, rewardGenerator('guard', 'townT5'))),
            getNeutralTown(4, rewardGenerator('town', 'centerT4'), getGuard(4, rewardGenerator('guard', 'townT4'))),
            getNeutralTown(2, rewardGenerator('town', 'centerT2'), getGuard(2, rewardGenerator('guard', 'townT2'))),
        }
    end
        ...
        zoneMerchants = {
            {
                ...
                guard = getGuard(4, rewardGenerator('guard', 'merchGuardT4'))           
            }
        }
    elseif scenarioSize == 96 then
        zoneMerchants = {
            {
                ...
                guard = getGuard(3, rewardGenerator('guard', 'merchGuardT3'))
            },
            {
                goods = {
                    items = rewardGenerator('merchant', 'T3'),
    ...
    return {
        ...
        mages = {
            getMageTower(2, getGuard(3, rewardGenerator('guard', 'merchGuardT3'))),
            getMageTower(3, getGuard(4, rewardGenerator('guard', 'merchGuardT4')))
        },
...
function getBigZone(zoneId, zoneSize, scenarioSize)
    ...
    if scenarioSize == 72 then
        zoneRuins = {
            getRuins(3, { min = 500, max = 570 }, getGuard(3, { }), rewardGenerator('ruins', 'bigBanner')),
            getRuins(3, { min = 550, max = 620 }, getGuard(3, { }), rewardGenerator('ruins', 'bigArtifact')),
            getRuins(4, { min = 700, max = 900}, getGuard(4, { }), rewardGenerator('ruins', 'bigJewel'))
        }
    elseif scenarioSize == 96 then
        zoneRuins = {
            getRuins(3, { min = 500, max = 570 }, getGuard(3, { }), rewardGenerator('ruins', 'bigBanner')),
            getRuins(3, { min = 500, max = 570 }, getGuard(3, { }), rewardGenerator('ruins', 'bigArtifact')),
            getRuins(3, { min = 500, max = 600 }, getGuard(3, { }), rewardGenerator('ruins', 'bigArtifact')),
            getRuins(4, { min = 700, max = 900}, getGuard(4, { }), rewardGenerator('ruins', 'bigJewel'))
        }
    end
    ...
    if scenarioSize == 72 then
        zoneTowns = {
            getNeutralTown(2, rewardGenerator('town', 'bigT2'), getGuard(2, rewardGenerator('guard', 'townT2'))),
            getNeutralTown(4, rewardGenerator('town', 'bigT4'), getGuard(4, rewardGenerator('guard', 'townT4')))
        }
    elseif scenarioSize == 96 then
        zoneTowns = {
            getNeutralTown(1, rewardGenerator('town', 'bigT1'), getGuard(1, rewardGenerator('guard', 'townT1'))),
            getNeutralTown(2, rewardGenerator('town', 'bigT2'), getGuard(2, rewardGenerator('guard', 'townT2'))),
            getNeutralTown(4, rewardGenerator('town', 'bigT4'), getGuard(4, rewardGenerator('guard', 'townT4')))
        }
    end
    ...
    if zoneId == bigZone0Id then
        zoneOthers[1] = { getMercenary(getGuard(3, rewardGenerator('guard', 'otherGuard'))) }
        zoneOthers[2] = { }
    elseif zoneId == bigZone4Id then
        zoneOthers[1] = { }
        zoneOthers[2] = { { guard = getGuard(3, rewardGenerator('guard', 'otherGuard')) } }
    end
...
function getConnections(scenarioSize)
    ...
    if scenarioSize == 72 then
        connections = {
            { from = startZone2Id, to = bufferZone1Id, guard = getGuard(3, rewardGenerator('guard', 'guardStartBuffer')) },
            { from = startZone2Id, to = bufferZone3Id, guard = getGuard(3, rewardGenerator('guard', 'guardStartBuffer')) },
            { from = startZone2Id, to = treasureZone8Id, guard = getGuard(6, rewardGenerator('guard', 'guardStartTreasure')) },
            
            { from = startZone6Id, to = bufferZone5Id, guard = getGuard(3, rewardGenerator('guard', 'guardStartBuffer')) },
            { from = startZone6Id, to = bufferZone7Id, guard = getGuard(3, rewardGenerator('guard', 'guardStartBuffer')) },
            { from = startZone6Id, to = treasureZone8Id, guard = getGuard(6, rewardGenerator('guard', 'guardStartTreasure')) },
    
            { from = bufferZone1Id, to = bigZone0Id, guard = getGuard(4, rewardGenerator('guard', 'guardBufferBig')) },
            { from = bufferZone7Id, to = bigZone0Id, guard = getGuard(4, rewardGenerator('guard', 'guardBufferBig')) },
    
            { from = bufferZone3Id, to = bigZone4Id, guard = getGuard(4, rewardGenerator('guard', 'guardBufferBig')) },
            { from = bufferZone5Id, to = bigZone4Id, guard = getGuard(4, rewardGenerator('guard', 'guardBufferBig')) },
    
            { from = bigZone0Id, to = treasureZone8Id, guard = getGuard(5, rewardGenerator('guard', 'guardBigTreasure')) },
            { from = bigZone4Id, to = treasureZone8Id, guard = getGuard(5, rewardGenerator('guard', 'guardBigTreasure')) },
    
            { from = bufferZone1Id, to = treasureZone8Id, guard = getGuard(6, rewardGenerator('guard', 'guardBufferTreasure')) },
            { from = bufferZone3Id, to = treasureZone8Id, guard = getGuard(6, rewardGenerator('guard', 'guardBufferTreasure')) },
            { from = bufferZone5Id, to = treasureZone8Id, guard = getGuard(6, rewardGenerator('guard', 'guardBufferTreasure')) },
            { from = bufferZone7Id, to = treasureZone8Id, guard = getGuard(6, rewardGenerator('guard', 'guardBufferTreasure')) },
...
template = {
    name = 'freedom 0.9.7',
    description = 'freedom 0.9.7S by obscure, SMNS2, 72x72 or 96x96, 2 players, 2 big zones, 4 junction zones, 1 treasure zone',
    minSize = 72,
    maxSize = 96,
    maxPlayers = 2,
    roads = 50,
