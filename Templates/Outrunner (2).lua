...
-- переменные для ист-ков зона тренера (для каждой расы)
	...
	-- Заклы баш_т2 т1*10шт : Исцеление, быстрота, Ледяной щит, сила витара, Menta minoris, tormentio, Порченная руна, слабость, Смятение, стая 		
	local tblmg2t1 = {'g000ss0007','g000ss0002','g000ss0021','g000ss0023','g000ss0044','g000ss0045','g000ss0134','g000ss0064','g000ss0106','g000ss0101'} 

	-- Заклы баш_т2 т2*11шт : сокрушение, Заступничество, прокл.эмира, Ритуал исцеления, terebrare corde, Chronos, Отсрочка неизбежного, Спешащее время, могущество, Песнь слез, Дикие саженцы	
	local tblmg2t2 = {'g000ss0183','g000ss0197','g000ss0184','g000ss0029','g000ss0185','g000ss0050','g000ss0124','g000ss0186','g000ss0187','g000ss0133','g000ss0107'} 
...
function zoneMageResp()
	...
	return {
		{
			spells = { 	tblmg2t1[1], tblmg2t1[2], tblmg2t1[3], tblmg2t1[4],
		...
		subraceTypes = rsub(),		
			...
			loot = {
				...
				items = {
					...
					{ id = rnd('g001ig0530','g001ig0530',rms()), min = 1, max = 1 }, -- зелье посмертного зова (талики) 66% / случ.шар манны 33%
		...
		stack = {
			...
			loot = {
				items = {
					...
					{ id = rnd('g001ig0524','g001ig0524',ExtraMana(playerRace)), min = 1, max = 1 }, -- Зелье завоевателя (жезлы) 66% | шар доп маны 33%
		...
		stack = {
			...
			loot = {
				...
				items = {
					...
					{ id = rnd('g001ig0526','g001ig0527',p05(),p05(),p05(),ExtraHomeMana(playerRace)), min = 1, max = 1 }, -- Зелье оруженосца (знамёна) / Зелье постижения (реликвии) / Пермо 5% / шар родной манны
		...
		stack = {
			...
			loot = {
				items = {
					...
					orr({ id = rnd('g000ig0018',rms()), min = 1, max = 1 }), -- хил200/случ.шар манны
					{ id = e4(), min = 1, max = 1 }, --эл400
					{ id = rnd('g000ig0015','g000ig0003'), min = 1, max = 1 }, --урон30/защита30
...
--релики 400-500x11: книга колдовства, книга т.з., Борода Имира, Кожаные эльфийские доспехи, Оковы долга, перчатки, Медицинский трактат, книга возд / книга воды / книга земли / книга огня
local relRespZ = {'g001ig0497','g000ig4006','g001ig0421','g001ig0428','g001ig0610','g001ig0099','g000ig4007',rnd('g000ig4001','g000ig4002','g000ig4003','g000ig4004')}

--знамёна 6x400+500: защиты, выносл, силы, быстроты, сражения, Знамя мастера
local flagRespZ = {'g000ig1001','g001ig0051','g000ig1007','g000ig1005','g000ig1003','g001ig0587'}
...
--для первой лавки
--арты 800-1000x12: д.чаша, рун.жизн800, прокл.пепел950, Кольцо темных искуств, Рог возмездия, Руна верности, кров.свят, кол.силы, Щит телохранителя, Монолитный щит, серд.эмира, Эльфийская брошь
local artResp1 = {'g000ig3002','g001ig0047','g001ig0197','g001ig0487','g001ig0558','g001ig0417','g001ig0045','g000ig3003','g001ig0594','g001ig0592','g000ig9137','g001ig0071'}

--релики 650-800x6: зуб людоеда, лютня650, Вечные латы, Книга постижения, Кровавый покров, Шлем проклятого
local relResp1 = {'g001ig0104','g000ig3022','g001ig0420','g001ig0605','g001ig0422','g001ig0037'}

--знамёна 600-800x5: гор.стр700, разум700,энерг700,искоренителя ереси600, главаря наемников800
local flagResp1 = {'g001ig0289','g001ig0145','g000ig1008','g001ig0370','g002ig0003'}
...
--для второй лавки
--арты 700-1000x11: кинж. вамп., пер.песк1000, Благословенный браслет, рун.мол800, Камень врат, Руна благоволения Тиу, Рог непреклонности, Руна предвидения Вотана, Щит неведения, Наручи с черепом, Щит отражения
local artResp2 = {'g000ig3017','g001ig0040','g001ig0155','g001ig0196','g001ig0582','g001ig0559','g001ig0557','g001ig0416','g001ig0589','g000ig2003','g001ig0591'}
...
return {
	{
		goods = {
			...
			items = {
				...
				--сапоги
				{ id = rnd('g000ig8003','g001ig0516'), min = 1, max = 1 }, -- Сапоги скорости / Зелье омоложения разума (-10 опыт)
...
--арты 1000-1450x14,2400: арт-контроль01, рун.клин1200, рог.всев1200, клин.возв1200, Клинок Танатоса, Кольцо небесной воли, Кольцо Несгибаемого стража, Корни триббога, Руна кары Тьяцци, Щит Мизраэля, Тысяча чешуек, Чаша жатвы, Топор палача, Серп Кровавого Ворона, Щит рыцаря Феникса
local artZone34 = {artctrl01(),'g000ig3004','g000ig2004','g001ig0124','g000ig3019','g001ig0612','g001ig0488','g001ig0413','g001ig0415','g001ig0590','g001ig0060','g001ig0603','g001ig0657','g002ig0013','g002ig0011'}
...
--знамёна 700x10: неуязв700, скорости700, болот, ветра перемен, отваги, стального листопада, Кошмаров, наследия, Стяг чумных воинств, Знамя тысячи битв +15опыт 750
local flagZone34 = {'g000ig1002','g000ig1006','g001ig0362','g001ig0364','g001ig0363','g001ig0374','g001ig0365','g001ig0375','g001ig0367','g001ig0588'}

--сферы 600-700x9,800x2: сфера-контроль01, Энергии +25аоеурон 500, Брони II 25 600, Вампиризма III 60 700, Великого исцеления 80 700, Массового ослабления II 50 700, Морской пучины 110урон 700, Горы урон110 800, Спасения 100хил 2колонны 700, Угнетения 110 урон 700, Урона III +урон60 700
...
--арты 12: арт-контроль02, Грань реальности, Кинжал жатвы, Кольцо создателя, Кровь Владыки, Дьявольская булава, Коготь Пожирателя, Гравированная диадема, Слеза Мортис, Копье Ангела, Кама Кровавого Ворона, Меч рыцаря Феникса
local artZone5 = {artctrl02(),'g001ig0411','g001ig0604','g001ig0585','g001ig0046','g001ig0410','g001ig0102','g000ig2005','g000ig9035','g002ig0017','g002ig0014','g002ig0010'}
...
--знамёна 9: магии Воды 700, Воздуха, Земли, Огня, Разума, Смерти, Стяг Кровавого Ворона 2250, Стяг багровых рек 1700, Знамя магического иммунитета 1600
local flagZone5 = {'g001ig0142','g001ig0140','g001ig0141','g001ig0139','g001ig0145','g001ig0143','g002ig0016','g001ig0366','g001ig0373'}

--сферы 700-1000x14: сфера-контроль02, Алчности 60 вамп аое 900, Массового замедления 50 1000, Брони III 35 800, Испепеления 110урон 700, Грозы 110урон 700,Обширной коррозии II -20брони аое 700, Древнего вамп100 800, защиты от Оружия 800, Землетрясения 75 колонны 900, Терзаний 85 ряд 900, Урагана 99 2x2 900, цунами 90 неприкр 900, направленного ослабления II 50 700
local orbZone5 = {orbctrl02(),'g000ig9025','g000ig9014','g001ig0136','g001ig0457','g000ig9028','g001ig0183','g001ig0303','g001ig0059','g001ig0459','g001ig0477','g000ig9027','g000ig9032','g001ig0462'}
...
--				itemValue = { min = 850, max = 1090 }
			items = {
				...
				-- Кольцо Несгибаемого стража (Артефакт) / Проклятый пепел (Артефакт) / Топор палача (Артефакт) / Клинок Возвышенного (Артефакт) / Кольцо небесной воли (Артефакт) / Перстень песков (Артефакт) / 
				...
				{id = rnd('g001ig0424','g001ig0425','g001ig0430','g001ig0539','g001ig0156','g001ig0419','g001ig0488','g001ig0197','g001ig0657','g001ig0124','g001ig0612','g001ig0040','g001ig0603','g001ig0041','g001ig0591','g001ig0071'), min = 1, max = 1},
			},
...
-- Источники т1 - голда и родная и ценная+менее(инверс для т2 делаю в своде)
...
-- Источники т2 - голда и родная и ценная+менее(инверс для т1 делаю в своде)
...
--
	...
	elseif race == Race.Elf and race2 == Race.Dwarf then return {gold = 1, groveMana = 1, runicMana = 1, deathMana = tbl[2], infernalMana = tbl[3], lifeMana = tbl[4]}
...
--	elseif radn == 2 then
--	return 'g001ig0414' -- Отравленный вороний коготь (Артефакт) 2600 (40% шанс на Паралич. -35% инициативы.) имбово!!!
	end
end
...
return { -- 400xp*2 / свитки т1+т1
	...
	loot = {
		itemTypes = { Item.Scroll },
		value = { min = 590, max = 590 }, -- свиток т1+т1
		itemValue = { min = 200, max = 200 },
		items = {
...
return { -- 1000хп*2 -- сфера/свиток 400*2
	...
	loot = {
		...
		items = {
			orr({ id = 'g000ig0001', min = 1, max = 1 }, { id = 'g000ig0006', min = 1, max = 1 }), --рес/хил100
			{ id = 'g000ig0006', min = 1, max = 1 }, --хил100
			orr3({ id = pw6(), min = 1, max = 1 }, { id = 'g001ig0519', min = 1, max = 1 }, { id = 'g001ig0083', min = 1, max = 1 }), --перм.вард600 / Война престолов (-10 воры) 500 / Зелье рвения (+5 ини и точности)
			{ id = 'g001ig0128', min = 1, max = 1 }, --оружия
...
{from = 2, to = 3}, {from = 2, to = 3}, {from = 2, to = 3}, {from = 2, to = 3}, {from = 2, to = 3}, {from = 2, to = 3}, {from = 2, to = 3}, {from = 2, to = 3}, {from = 2, to = 3},   
{from = 5, to = 6}, {from = 5, to = 6}, {from = 5, to = 6}, {from = 5, to = 6}, {from = 5, to = 6}, {from = 5, to = 6}, {from = 5, to = 6}, {from = 5, to = 6}, {from = 5, to = 6},   
