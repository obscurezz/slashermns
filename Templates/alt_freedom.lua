...
local low_level_macro_scrolls = {'g000ig5119', 'g000ig5084', 'g000ig5009', 'g001ig0195', 'g001ig0492', 'g001ig0072', 'g000ig5022', 'g000ig5027', 'g001ig0407', 'g000ig5042', 'g000ig5041', 'g000ig5025', 'g000ig5061', 'g000ig5098'}
...
function getStartingZone(zoneId, playerRace, zoneSize)
    ...
    zoneContent['border'] = Border.Water
    ...
    zoneContent['stacks'] = {
        ...
        getSingleStack(1, {Item.PotionHeal}, 50, 150, 1),
        getSingleStack(1, {Item.PotionHeal}, 50, 150, 1),
        getSingleStack(1, {Item.PotionRevive}, 250, 250, 1),
        getSingleStack(1, {Item.PotionRevive}, 250, 250, 1),
        ...
        getSingleStack(2, {Item.PotionBoost, Item.PotionHeal}, 50, 200, 2),
        getSingleStack(2, {Item.PotionBoost, Item.PotionHeal}, 50, 200, 2),
    ...
    zoneContent['merchants'] = {
        getMerchant({Item.Orb, Item.Scroll, Item.Wand}, 200, 400, 15, getGuard(2, subraceRandomizer(1), {Item.Valuable}, 100, 500, 2, getExacts('t1MerchantExacts'))),
        getMerchant({Item.Armor, Item.Weapon, Item.TravelItem, Item.Banner, Item.Jewel}, 300, 600, 15, getGuard(2, subraceRandomizer(1), {Item.Valuable}, 100, 500, 2, getExacts('t1MerchantExacts'))),
    }
    zoneContent['towns'] = {
...
function getBigZone(zoneId, zoneSize)
    ...
    zoneContent['stacks'] = {
        getSingleStack(2, {Item.PotionHeal}, 50, 150, 2),
        getSingleStack(2, {Item.PotionHeal}, 50, 150, 2),
        getSingleStack(3, {Item.PotionHeal, Item.PotionRevive}, 50, 250, 2),
        getSingleStack(3, {Item.PotionHeal, Item.PotionRevive}, 50, 250, 2),
        getSingleStack(3, {Item.PotionBoost, Item.PotionRevive}, 150, 350, 2),
    ...
    local itemMerchant = getMerchant({Item.Armor, Item.Weapon, Item.Jewel, Item.Banner}, 700, 900, 10, getGuard(3, subraceRandomizer(2), {Item.Valuable}, 250, 750, 2, getExacts('t3MerchantExacts')))
    ...
    zoneContent['mages'] = {
        getMageTower(2, getGuard(4, subraceRandomizer(2), {Item.Valuable}, 100, 500, 2, getExacts('t2MerchantExacts')))
    }
    zoneContent['mercenaries'] = {
...
function getConnections()
    ...
    local connections = {
            ...
            { from = startZone2Id, to = bufferZone3Id, guard = getGuard(3, {Subrace.NeutralBarbarian, Subrace.Dwarf}, {Item.PotionPermanent}, 450, 650, 1, getExacts('startBufferExacts')) },
            { from = startZone2Id, to = treasureZone8Id, guard = getGuard(5, subraceRandomizer(GO), {Item.Armor, Item.Weapon}, 700, 1000, 1, getExacts('startTreasureExacts')) },
            ...
            { from = startZone6Id, to = bufferZone7Id, guard = getGuard(3, {Subrace.NeutralBarbarian, Subrace.Dwarf}, {Item.PotionPermanent}, 450, 650, 1, getExacts('startBufferExacts')) },
            { from = startZone6Id, to = treasureZone8Id, guard = getGuard(5, subraceRandomizer(GO), {Item.Armor, Item.Weapon}, 700, 1000, 1, getExacts('startTreasureExacts')) },
