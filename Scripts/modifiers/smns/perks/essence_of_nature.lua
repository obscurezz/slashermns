...
-- myModValue = Id.new('g070um0268').value
...
function canApplyToUnit(unitImpl)
	...
	local HAS_MOD = unitImpl:hasModifier(Id.new('g070um0267')) or unitImpl:hasModifier(Id.new('g070um0269')) or unitImpl:hasModifier(Id.new('g070um0270')) or unitImpl:hasModifier(Id.new('g070um0271'))
	if HAS_MOD then
		return false
	end
	return true
...
function getArmor(unit, prev)
	local mana_criteria = math.min(1000, _getPlayerBank(unit).groveMana)
	return svFlatEffectArmor(unit, prev, 0.015 * mana_criteria)
end