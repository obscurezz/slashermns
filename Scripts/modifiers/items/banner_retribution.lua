...
function getModifierDisplay(unit, prev)
	return _modifDisplay_AttackProtectionIgnorance(unit, prev)
end

function getModifierDescTxt(unit, prev)
	return _modifCustomTxt_AttackProtectionIgnorance(unit, prev)
end
...
function getAttackCritPower(unit, prev)
	return svAddCrit1Power(unit, prev, 15)
end
...
function getAttack2CritPower(unit, prev)
	return svAddCrit2Power(unit, prev, 15)
end
