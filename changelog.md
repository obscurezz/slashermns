...
1. **Рефаим** изменен:
    ...
    * Базовый урон по области изменен с _50%_ на _100%_
...
4. Модификатор _Кара_ **Юстициара** изменен с _+20% + 10% за оверлевел шанс на двойную атаку_ на _+20% + 10% за оверлевел шанс на критический удар 35%_
5. У **Клинка в тени** удален модификатор _Бдительность I_
6. У **Кары Императора** удален модификатор _Бдительность II_
7. **Клинку в тени** добавлен модификатор _Налетчик_
8. **Каре Императора** добавлен модификатор _Налетчик_
9. **Каре Императора** добавлен модификатор _Отточенное мастерство: +1% критического урона за оверлевел_
